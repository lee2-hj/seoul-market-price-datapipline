...
def build_gold_mart_context(base_date: date) -> GoldMartContext:
    ...
    fact_df = (
        ...
        .select(
            ...
            "price_ten_thousand", "exclusive_area_m2", "floor", "cancel_date", "deal_date", "mno", "sno",
        )
    )
    ...
    geocode_rows = _geocode_apartments(
        distinct_apt_rows, jibun_lookup, kakao_api_key, persistent_location_cache
    )
